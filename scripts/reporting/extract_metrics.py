...
# Example Usage
log_file_path = "results/logs/generated/yolo11n.log"  # Replace with your .log file path
extracted_data = extract_specific_lines(log_file_path)
save_results_to_json(extracted_data, output_folder="results/extracted", output_file="yolo11n.json")
